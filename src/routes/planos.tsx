...
const PLANS: { id: string; name: string; price: number; period: string; icon: LucideIcon; color: string; popular?: boolean; features: string[]; desc: string }[] = [
  ...
  { id: "ultra30", name: "Ultra 30D", price: 19.20, period: "30 dias", icon: Shield, color: "#5ab8e0", desc: "Alto volume de buscas", features: ["30 dias de acesso", "500 buscas por dia", "Até 5.000 resultados", "Acesso a todas as fontes", "Suporte VIP"] },
