      ...
      <main className="mx-auto max-w-4xl px-6 py-10 space-y-8">
        ...
        {isLoading ? (
          ...
          <>
            <section className="rounded-2xl border border-border bg-card/40 p-6">
              ...
              {acc?.subscription ? (
                ...
                <div className="mt-4 rounded-xl border border-border bg-background/60 p-5">
                  ...
                  <Link to="/planos" className="mt-3 inline-flex items-center justify-center gap-2 rounded-full h-10 px-6 text-sm font-semibold text-white transition-all duration-200"
                    style={{
            ...
            {acc?.isAdmin ? (
              <Link to="/admin" className="inline-flex items-center justify-center gap-2 rounded-full border border-border/60 bg-card/40 h-10 px-6 text-sm font-semibold text-muted-foreground transition hover:text-foreground hover:border-primary/30 hover:bg-primary/5">
                Painel admin
              </Link>
            ) : (
              <ClaimAdmin />
  ...
  return (
    <div className="rounded-xl border border-dashed border-border bg-background/40 p-4 text-sm">
      ...
      <button
        ...
        className="mt-2 inline-flex items-center justify-center rounded-full border border-border/60 bg-card/40 h-9 px-4 text-xs font-semibold text-muted-foreground transition hover:text-foreground hover:border-primary/30 hover:bg-primary/5"
